...
import org.cxa.stateMachine.State.StateType;
...
public class StateMachine<T> implements Updatable
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.cxa.misc.updater.Updatable#start()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.cxa.misc.updater.Updatable#stop()
	 */
	@Override
	public void stop() { }
